...
#include "PieceEstrategiaVerde.generated.h"

UCLASS()
class TETRISUSFX01_API APieceEstrategiaVerde : public AActor, public IPieceCaracteristicasEstrategia
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	APieceEstrategiaVerde();
