...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Materiales;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APiece_Statics::NewProp_Materiales_MetaData[] = {
		{ "Category", "Piece" },
		{ "Comment", "/*TArray<class UMaterial*> Colors;*/" },
		{ "ModuleRelativePath", "Piece.h" },
		{ "ToolTip", "TArray<class UMaterial*> Colors;" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APiece_Statics::NewProp_Materiales = { "Materiales", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APiece, Materiales), Z_Construct_UClass_AMaterialesPiece_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APiece_Statics::NewProp_Materiales_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APiece_Statics::NewProp_Materiales_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APiece_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APiece_Statics::NewProp_Materiales,
	};
	...
	IMPLEMENT_CLASS(APiece, 149141351);
