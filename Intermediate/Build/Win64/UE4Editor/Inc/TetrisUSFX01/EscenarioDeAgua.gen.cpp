...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEscenarioDeAgua_Statics::NewProp_CorazonAire = { "CorazonAire", nullptr, (EPropertyFlags)0x0040000000020001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEscenarioDeAgua, CorazonAire), Z_Construct_UClass_ACorazonAire_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AEscenarioDeAgua_Statics::NewProp_CorazonAire_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEscenarioDeAgua_Statics::NewProp_CorazonAire_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEscenarioDeAgua_Statics::NewProp_Corazon_MetaData[] = {
		{ "Category", "Principal" },
		{ "ModuleRelativePath", "EscenarioDeAgua.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEscenarioDeAgua_Statics::NewProp_Corazon = { "Corazon", nullptr, (EPropertyFlags)0x0040000000020001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEscenarioDeAgua, Corazon), Z_Construct_UClass_ACorazonVida_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AEscenarioDeAgua_Statics::NewProp_Corazon_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEscenarioDeAgua_Statics::NewProp_Corazon_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEscenarioDeAgua_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEscenarioDeAgua_Statics::NewProp_Corazon,
	};
	...
	IMPLEMENT_CLASS(AEscenarioDeAgua, 3174363074);
